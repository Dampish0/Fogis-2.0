...
import { createReferee, deleteReferee, getRefereeById, getRefereeMatches, getReferees, updateReferee } from "../controllers/refereeController.js";
...
let allowHistoryAccessRoles = ["admin", "superadmin", "dev", "referee"];
...
router.get("/history/:id", verifyToken, getAuthRoleMiddleware(allowHistoryAccessRoles), getRefereeMatches);
